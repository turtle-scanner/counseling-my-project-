...
if check_password():
    ...
    # 공통 스타일 설정 (가독성 극대화: 블랙 배경, 화이트 텍스트, 옐로우 포인트)
    st.markdown("""
        <style>
        /* 1. 전체 배경 및 기본 텍스트 설정 */
        ...
        th {
            ...
            color: #fcd34d !important; /* 헤더는 노란색으로 포인트 */
        }
    ...
    if page == "1. 주도주 타점 스캐너":
        ...
        with tab1:
            ...
            mb_data = {
                ...
                "진입가": ["$910", "$68", "$24", "185,000", "142,000"],
                "목표가": ["$1,100", "$85", "$30", "220,000", "170,000"],
                "손절가": ["$880", "$65", "$22.5", "178,000", "136,000"],
                "익절가": ["$1,050", "$80", "$28", "210,000", "165,000"],
                "RS": ["98", "94", "91", "99", "95"],
                "ROE": ["45%", "32%", "12%", "28%", "35%"],
                "종합점수": ["🟢 좋음", "🟢 좋음", "🟡 보통", "🟢 좋음", "🟡 보통"],
                "상승률": ["+6.2%", "+4.8%", "+5.1%", "+8.5%", "+5.2%"],
        ...
        with tab2:
            ...
            ep_data = {
                ...
                "진입가": ["$65", "$45", "18,400", "19,800"],
                "목표가": ["$90", "$60", "25,000", "28,000"],
                "손절가": ["$61", "$42", "17,200", "18,500"],
                "익절가": ["$85", "$55", "23,500", "26,000"],
                "RS": ["96", "89", "97", "85"],
                "ROE": ["N/A", "15%", "40%", "18%"],
                "종합점수": ["🟢 좋음", "🟡 보통", "🟢 좋음", "🔴 나쁨"],
                "상승갭": ["+8.5%", "+6.2%", "+8.4%", "+7.5%"],
